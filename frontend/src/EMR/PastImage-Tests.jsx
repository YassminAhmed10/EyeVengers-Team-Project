...
const PastImageTests = ({ patientId }) => {
    ...
    return (
        <Box sx={{ mt: 3, maxWidth: '1400px', margin: '0 auto' }} className="past-images-container">
                        ...
                        >
                            {file.type === "image" ? (
                                <img
                                    src={file.url}
                                    alt={file.name}
                                    style={{ width: "100%", minHeight: "300px", objectFit: "cover", borderRadius: 4 }}
                                />
                            ) : (
                                <Box
                                    sx={{
                                ...
                                >
                                    <Typography sx={{ fontSize: '1.3rem', fontWeight: 600 }}>{file.name}</Typography>
                                </Box>
                            )}
                            <Typography
                                sx={{
