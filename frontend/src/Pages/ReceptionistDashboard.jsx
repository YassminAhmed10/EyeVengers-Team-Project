      ...
      <div className="dashboard-stats">
        <div className="stat-card baby-blue">
          ...
          <div className="stat-content">
            <h3 style={{ color: '#000000 !important' }}>Online Appointments</h3>
            <p className="stat-number" style={{ color: '#000000 !important', fontWeight: '900', fontSize: '2.5rem', textShadow: 'none' }}>{statistics.totalOnlineAppointments}</p>
          </div>
        </div>
        ...
        <div className="stat-card light-purple">
          ...
          <div className="stat-content">
            <h3 style={{ color: '#000000 !important' }}>Offline Appointments</h3>
            <p className="stat-number" style={{ color: '#000000 !important', fontWeight: '900', fontSize: '2.5rem', textShadow: 'none' }}>{statistics.totalOfflineAppointments}</p>
          </div>
        </div>
        ...
        <div className="stat-card mint-green">
          ...
          <div className="stat-content">
            <h3 style={{ color: '#000000 !important' }}>Total Appointments</h3>
            <p className="stat-number" style={{ color: '#000000 !important', fontWeight: '900', fontSize: '2.5rem', textShadow: 'none' }}>{statistics.totalAppointments}</p>
          </div>
        </div>
        ...
        <div className="stat-card soft-pink">
          ...
          <div className="stat-content">
            <h3 style={{ color: '#000000 !important' }}>Pending Requests</h3>
            <p className="stat-number" style={{ color: '#000000 !important', fontWeight: '900', fontSize: '2.5rem', textShadow: 'none' }}>{statistics.pendingOnlineRequests}</p>
          </div>
        </div>
      </div>
