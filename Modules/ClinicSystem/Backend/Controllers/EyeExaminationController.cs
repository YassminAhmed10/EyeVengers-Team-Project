...
using EyeClinicAPI.DTOs.EyeExamination;
...
namespace EyeClinicAPI.Modules.ClinicSystem.Controllers
{
    ...
    public class EyeExaminationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(int id, UpdateEyeExaminationRequest request)
        {
            ...
            exam.ODSph = request.ODSph;
            exam.ODCyl = request.ODCyl;
            exam.ODAxis = request.ODAxis;
            exam.ODAdd = request.ODAdd;
            exam.OSSph = request.OSSph;
            exam.OSCyl = request.OSCyl;
            exam.OSAxis = request.OSAxis;
            exam.OSAdd = request.OSAdd;
            exam.PD = request.PD;
